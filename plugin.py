...
"""
"""
<plugin key="SDM630" name="Eastron SDM630-Modbus" version="2" author="MFxMF/gizmocuz">
    <params>
        <param field="SerialPort" label="Modbus Port" width="200px" required="true" default="/dev/ttyUSB0" />
        <param field="Mode1" label="Baud rate" width="40px" required="true" default="9600"  />
        <param field="Mode2" label="Device IDs" width="240px" required="true" default="1" />
        ...
        if self.runInterval <= 0:
            ...
            for mbid in modbusIDs:
                try:
                    ...
                    Volts_L1 = self.rs485.read_float(0, 4, 2)
                    Volts_L2 = self.rs485.read_float(2, 4, 2)
                    Volts_L3 = self.rs485.read_float(4, 4, 2)
                    Current_L1 = self.rs485.read_float(6, 4, 2)
                    Current_L2 = self.rs485.read_float(8, 4, 2)
                    Current_L3 = self.rs485.read_float(10, 4, 2)
                    Active_Power_L1 = self.rs485.read_float(12, 4, 2)
                    Active_Power_L2 = self.rs485.read_float(14, 4, 2)
                    Active_Power_L3 = self.rs485.read_float(16, 4, 2)
                    Apparent_Power_L1 = self.rs485.read_float(18, 4, 2)
                    Apparent_Power_L2 = self.rs485.read_float(20, 4, 2)
                    Apparent_Power_L3 = self.rs485.read_float(22, 4, 2)
                    Reactive_Power_L1 = self.rs485.read_float(24, 4, 2)
                    Reactive_Power_L2 = self.rs485.read_float(26, 4, 2)
                    Reactive_Power_L3 = self.rs485.read_float(28, 4, 2)
                    Power_Factor_L1 = self.rs485.read_float(30, 4, 2)
                    Power_Factor_L2 = self.rs485.read_float(32, 4, 2)
                    Power_Factor_L3 = self.rs485.read_float(34, 4, 2)
                    Phase_Angle_L1 = self.rs485.read_float(36, 4, 2)
                    Phase_Angle_L2 = self.rs485.read_float(38, 4, 2)
                    Phase_Angle_L3 = self.rs485.read_float(40, 4, 2)
                    Average_line_to_neutral_volts = self.rs485.read_float(42, 4,2)
                    Average_line_current = self.rs485.read_float(46, 4,2)
                    Sum_of_line_current = self.rs485.read_float(48, 4,2)
                    Total_System_Active_Power = self.rs485.read_float(52, 4,2)
                    Total_System_Apparent_Power = self.rs485.read_float(56, 4,2)
                    Total_System_Reactive_Power = self.rs485.read_float(60, 4,2)
                    Total_System_Power_Factor = self.rs485.read_float(62, 4,2)
                    Total_System_Phase_Angle = self.rs485.read_float(66, 4, 2)
                    Frequency_Of_Supply_Voltages = self.rs485.read_float(70, 4, 2)
                    Import_Wh_since_last_reset = self.rs485.read_float(72, 4, 2)
                    Export_Wh_since_last_reset = self.rs485.read_float(74, 4, 2)
                    Import_VArh_since_last_reset = self.rs485.read_float(76, 4, 2)
                    Export_VArh_since_last_reset = self.rs485.read_float(78, 4, 2)
                    VAh_since_last_reset = self.rs485.read_float(80, 4, 2)
                    Ah_since_last_reset = self.rs485.read_float(82, 4, 2)
                    Total_system_power_demand = self.rs485.read_float(84, 4, 2)
                    Maximum_total_system_power_demand = self.rs485.read_float(86, 4, 2)
                    Total_system_VA_demand = self.rs485.read_float(100, 4, 2)
                    Maximum_total_system_VA_demand = self.rs485.read_float(102, 4, 2)
                    Neutral_current_demand = self.rs485.read_float(104, 4, 2)
                    Maximum_neutral_current_demand = self.rs485.read_float(106, 4, 2)
                    Line_1_to_Line_2_volts = self.rs485.read_float(200, 4, 2)
                    Line_2_to_Line_3_volts = self.rs485.read_float(202, 4, 2)
                    Line_3_to_Line_1_volts = self.rs485.read_float(204, 4, 2)
                    Average_line_to_line_volts = self.rs485.read_float(206, 4, 2)
                    Neutral_current = self.rs485.read_float(224, 4, 2)
                    Phase_1_LN_volts_THD = self.rs485.read_float(234, 4, 2)
                    Phase_2_LN_volts_THD = self.rs485.read_float(236, 4, 2)
                    Phase_3_LN_volts_THD = self.rs485.read_float(238, 4, 2)
                    Phase_1_Current_THD = self.rs485.read_float(240, 4, 2)
                    Phase_2_Current_THD = self.rs485.read_float(242, 4, 2)
                    Phase_3_Current_THD = self.rs485.read_float(244, 4, 2)
                    Average_line_to_neutral_volts_THD = self.rs485.read_float(248, 4, 2)
                    Average_line_current_THD = self.rs485.read_float(250, 4, 2)
                    Total_system_power_factor = self.rs485.read_float(254, 4, 2)
                    Phase_1_current_demand = self.rs485.read_float(258, 4, 2)
                    Phase_2_current_demand = self.rs485.read_float(260, 4, 2)
                    Phase_3_current_demand = self.rs485.read_float(262, 4, 2)
                    Maximum_phase_1_current_demand = self.rs485.read_float(264, 4, 2)
                    Maximum_phase_2_current_demand = self.rs485.read_float(266, 4, 2)
                    Maximum_phase_3_current_demand = self.rs485.read_float(268, 4, 2)
                    Line_1_to_line_2_volts_THD = self.rs485.read_float(334, 4, 2)
                    Line_2_to_line_3_volts_THD = self.rs485.read_float(336, 4, 2)
                    Line_3_to_line_1_volts_THD = self.rs485.read_float(338, 4, 2)
                    Average_line_to_line_volts_THD = self.rs485.read_float(340, 4, 2)
                    Total_kwh = self.rs485.read_float(342, 4, 2)
                    Total_kvarh = self.rs485.read_float(344, 4, 2)
                    L1_import_kwh = self.rs485.read_float(346, 4, 2)
                    L2_import_kwh = self.rs485.read_float(348, 4, 2)
                    L3_import_kwh = self.rs485.read_float(350, 4, 2)
                    L1_export_kwh = self.rs485.read_float(352, 4, 2)
                    L2_export_kwh = self.rs485.read_float(354, 4, 2)
                    L3_export_kwh = self.rs485.read_float(356, 4, 2)
                    L1_total_kwh = self.rs485.read_float(358, 4, 2)
                    L2_total_kwh = self.rs485.read_float(360, 4, 2)
                    L3_total_kwh = self.rs485.read_float(362, 4, 2)
                    L1_import_kvarh = self.rs485.read_float(364, 4, 2)
                    L2_import_kvarh = self.rs485.read_float(366, 4, 2)
                    L3_import_kvarh = self.rs485.read_float(368, 4, 2)
                    L1_export_kvarh = self.rs485.read_float(370, 4, 2)
                    L2_export_kvarh = self.rs485.read_float(372, 4, 2)
                    L3_export_kvarh = self.rs485.read_float(374, 4, 2)
                    L1_total_kvarh = self.rs485.read_float(376, 4, 2)
                    L2_total_kvarh = self.rs485.read_float(378, 4, 2)
                    L3_total_kvarh = self.rs485.read_float(380, 4, 2)
